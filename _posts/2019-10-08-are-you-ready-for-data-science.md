...
_(Continued from Parts [1]({{ site.baseurl }}{% post_url 2019-10-06-you-dont-need-a-data-scientist %}) and [2]({{ site.baseurl }}{% post_url 2019-10-07-what-data-scientists-actually-do-all-day %}), where I explained why data scientists are usually a waste of time and money.)_
