...
header:
  ...
  overlay_filter: 0.7
---
_(Continued from [Part 1]({{ site.baseurl }}{% post_url 2019-11-23-get-the-most-value-from-your-data-scientist %}) of this series, where I explained how to onboard your data scientist so they're in a position to deliver business value ASAP.)_
...
(Don’t forget that you should have [defined a success metric]({{ site.baseurl }}{% post_url 2019-11-23-get-the-most-value-from-your-data-scientist %}#success-metrics) during onboarding!)
...
_(In the [final part]({{ site.baseurl }}{% post_url 2019-11-25-how-to-successfully-deliver-a-data-science-project %}) of this series, I'll talk about how to ensure your data science project is delivered successfully._
